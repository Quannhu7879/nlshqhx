...
export const LandingView: React.FC<LandingViewProps> = ({ onSwitchView }) => {
  ...
  return (
    <div className="space-y-12">
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-b from-slate-900 via-indigo-950 to-slate-900 text-white py-8 sm:py-10 px-4 sm:px-6 lg:px-8 rounded-2xl shadow-lg my-2">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 space-y-4">
          <span className="inline-flex items-center px-3 py-0.5 rounded-full text-[11px] font-semibold bg-indigo-500/20 text-indigo-300 border border-indigo-500/30">
          ...
          <div className="pt-2 flex flex-col md:flex-row items-center gap-2.5 w-full">
            {/* Short Box: Real-time Date & Time */}
            <div className="w-full md:w-auto shrink-0 bg-slate-900/90 border border-indigo-500/40 rounded-lg px-3 py-1.5 flex items-center justify-center space-x-2 text-indigo-200 text-xs font-mono shadow-inner min-w-[240px]">
            ...
            <div className="w-full flex-1 bg-slate-900/90 border border-indigo-500/40 rounded-lg px-3 py-1.5 overflow-hidden relative shadow-inner flex items-center">
              <div className="whitespace-nowrap animate-marquee text-amber-300 font-medium text-xs tracking-wide">
