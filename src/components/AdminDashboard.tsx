...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'analytics' | 'competencies' | 'prompt_config' | 'repo' | 'sql_schema'>('analytics');
    ...
    <div className="space-y-6">
      ...
      <div className="flex border-b border-slate-200 space-x-2">
        <button
          ...
          className={`py-2.5 px-4 text-xs font-bold transition border-b-2 flex items-center ${
            activeTab === 'analytics'
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex items-center space-x-4">
              ...
              <div>
                <span className="text-xs text-slate-500 block font-medium">Giáo Viên Hoạt Động</span>
